...
$STRAPI_TOKEN = "YOUR_STRAPI_TOKEN_HERE"; // Must have 'update' permission on Submissions
...
// We need the content to send to the AI
...
// Handle Strapi v4/v5 structure differences
