...
<head>
  <meta charset="utf-8">
  <title>Create Assignment — BSU</title>
  ...
  <style>
    ...
    .btn-create:hover { background-color: #157347; transform: translateY(-2px); box-shadow: 0 4px 12px rgba(25, 135, 84, 0.3); }
    ...
    .file-item { 
        ...
        background: #f8f9fa; padding: 10px 15px; border-radius: 8px; margin-top: 10px; font-size: 0.9rem; 
  ...
  <div class="row">
    ...
    <div class="col-md-3 col-lg-2 d-none d-md-block sidebar p-0">
      ...
      <nav class="nav flex-column px-2">
        ...
        <a class="nav-link active" href="#"><span class="material-icons">assignment</span> Create Assignment</a>
      </nav>
    </div>
    ...
    <main class="col-md-9 col-lg-10 ms-sm-auto px-md-4 main-content">
      ...
      <div class="d-flex justify-content-between align-items-center pb-3 mb-4 border-bottom">
        <h2 class="h2 fw-bold m-0">New Assignment</h2>
        <div class="dropdown">
          ...
          <div class="col-lg-8">
              ...
              <div class="form-card">
                  <div class="mb-4">
                      ...
                      <input type="text" class="form-control form-control-lg" id="assign-title" placeholder="Enter title">
                  </div>
                  
                  <div class="mb-4">
                      <label class="form-label">Instructions</label>
                      <textarea class="form-control" id="assign-instructions" rows="5" placeholder="Write instructions here"></textarea>
                  </div>
                  ...
                  <div class="d-flex justify-content-end">
                      <button class="btn-create" id="create-btn">Post Assignment</button>
                  </div>
              </div>
...
<script>
  ...
  // --- FILE UPLOAD ---
  const uploadArea = document.getElementById('upload-trigger');
      ...
      uploadedFiles.forEach((file, index) => {
          fileListDisplay.innerHTML += `
            <div class="file-item">
                ...
                <button class="btn-remove-file" onclick="removeFile(${index})" title="Remove">
  ...
  document.getElementById('create-btn').addEventListener('click', async () => {
    ...
    const url = 'http://localhost:1337/api/assignments';
    const body = {
      data: {
        title: title,
